...
- **[Kafka Chatrooms CLI](https://github.com/borgeskauan/kafka-chatrooms-cli)**  
...
- **[WhatsApp Microservices with Redis](https://github.com/borgeskauan/whatsapp-microservices-redis)**  
...
- **[WhatsApp Microservices](https://github.com/borgeskauan/whatsapp-microservices)**  
...
- **[Spring Cloud Functions](https://github.com/borgeskauan/spring-cloud-functions)**  
...
- **[Financial Transaction System](https://github.com/borgeskauan/financial-transaction-system)**  
...
- **[Mail Sender Azure Functions](https://github.com/borgeskauan/mailsender-az-functions)**  
  A simple mail sender project to practice integration with cloud services.  
  `serverless` `azure` `email`

- **[URL Shortener](https://github.com/borgeskauan/url-shortener)**  
...
- **[Stock Microservices](https://github.com/borgeskauan/stock-microservices)**  
...
- **[Investment Platform](https://github.com/borgeskauan/investment-platform)**  
...
- **Netflix Clone**
  ...
  - **[Backend](https://github.com/borgeskauan/netflix-backend)**  
...
- **WhatsApp Websockets (In development)**
  ...
  - **[Frontend](https://github.com/borgeskauan/whatsapp-websockets-2)** 
    React + NextJS frontend of the WhatsApp project.  
    `frontend` `react` `nextjs` `websockets` `in-development` `fullstack`
  - **[Backend](https://github.com/borgeskauan/whatsapp-backend)**
